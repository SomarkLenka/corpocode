...
function orchestration(over?: {
  ...
  return {
    ...
    swarm: { max_parallel_writers: 3, worktrees: true, attempts_per_task: 2, task_wallclock_ms: 600_000, run_wallclock_ms: 14_400_000 },
    depgate: { enabled: true, registry_check: false },
